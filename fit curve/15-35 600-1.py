...
# 文件路径列表
file_paths = [
    r'E:\清华云盘\陈显力_1\我的资料库\调研\碳纳米管薄膜气体温度场\实验数据\20241227\修正\1cm\数据提取\xlsx文件\更改名字\15V-600sccm.xlsx',
    r'E:\清华云盘\陈显力_1\我的资料库\调研\碳纳米管薄膜气体温度场\实验数据\20241227\修正\1cm\数据提取\xlsx文件\更改名字\25V-600sccm.xlsx',
...
# 设置刻度字体大小
plt.tick_params(axis='both', which='major', labelsize=18)  # 设置主刻度字体大小
plt.tick_params(axis='both', which='minor', labelsize=12)  # 设置次刻度字体大小
